...
- **Главное — слот на проект каждый день,** а не выполненное задание; один рабочий проект и наблюдаемое изменение в нём
- Проверяем, нужен ли документ или изменение самой системы; **конвейер — не перечень регламентов**, а система, в которой идут процессы
- Продукты недели выбираем под доступное время, сравниваем план с фактом; работаем **итерациями и инкрементами**
- Сначала думаем сами, затем проверяем с ИИ; аналогии уточняем на своём примере
