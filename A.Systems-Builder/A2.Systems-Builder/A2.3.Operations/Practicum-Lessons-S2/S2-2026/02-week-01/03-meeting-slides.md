...
1. Название вашего рабочего проекта
2. Первый рабочий продукт: есть / нет / в работе
3. Сколько дней из прошедших был слот времени на проект
4. Где застряли
...
![bg fit right:70%](../01-kickoff/assets/bylo-stalo-project.svg)
