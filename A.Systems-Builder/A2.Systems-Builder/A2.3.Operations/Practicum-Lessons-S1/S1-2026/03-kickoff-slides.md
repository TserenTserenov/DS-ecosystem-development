...
![bg fit right:58%](assets/bylo-stalo-project.svg)
...
![h:610](assets/learner-metrics.png)
...
Что нужно каждую неделю:

- Держать слот — не пропускать ежедневную самостоятельную работу
- Показать рабочий продукт недели по своему проекту — не «поработал», а конкретная вещь
- Пройти сверку с наставником в конце недели: сделано / не сделано, что мешало
- Развитие — это важное, а не срочное: без закреплённого слота его вытесняет текучка
