...
![bg fit right:45%](assets/bylo-stalo-project.svg)
...
## Другие отслеживаемые показатели по ступеням

Систематичность — главный, но не единственный показатель. На каждой ступени параллельно отслеживаются:
