---
created: 2026-09-11
updated: 2026-09-12 (Ф4: три готовые инфографики, укрупнение шрифтов в диаграммах, новый слайд про другие показатели, удаление слайда «работа на своём проекте» - синхронизация с `03-kickoff-slides.md`)
...
*Картинка `bylo-stalo-project.svg` теперь справа от текста (правая треть слайда), не отдельным блоком снизу.*
...
Свой проект вместо общего маршрута работает только тогда, когда что-то каждый раз определяет, какой именно кусок метода нужен вам сейчас - под вашу ступень и ваш проект. Раньше это делал наставник вручную на встрече. Теперь эту работу выполняет ИИ-среда - она и есть та технологическая основа, на которой стоит вся программа.
...
## Слайд 8 — Другие отслеживаемые показатели по ступеням

Систематичность - главный показатель, но не единственный. На каждой ступени параллельно отслеживаются ещё четыре шкалы:
...
Ступень подтверждается по совокупности всех показателей сразу, не по одной систематичности.

*(Те же четыре шкалы позже, на слайде 16, встречаются в таблице «Новичок» - там они про сложность входа, здесь про то, что отслеживается по ступеням. Смысл разный, но текст почти дословно повторяется - решить на финальном прогоне, нужно ли оба слайда.)*

---

## Слайд 9 — Основа созидателя: путь к вершине
...
## Слайд 10 — Где на этой лестнице начинается S1
...
*Текст в цветных ячейках («растит», «крепче», «первый заход») укрупнён и выделен жирным (12.09, пятый проход).*
...
## Слайд 12 — Вторая линия роста: мастерство работы с IWE
