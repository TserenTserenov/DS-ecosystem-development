...
<div style="align-self: start; margin-top: -30px; margin-right: -60px;">

![w:560](images/three-pains.png)
...
1. **ОРЗ дня** — открытие · работа · закрытие
2. **Каскад планирования** — стратегия → неделя → день
3. **Учёт времени** — что куда идёт
4. **Структура знаний** — Pack, база, понятия
5. **ВДВ** — вопрос · допущение · вывод
...
9. **Мультитаскинг** → **мультиагентность**
...
![w:520](images/envs-changeable.png)
