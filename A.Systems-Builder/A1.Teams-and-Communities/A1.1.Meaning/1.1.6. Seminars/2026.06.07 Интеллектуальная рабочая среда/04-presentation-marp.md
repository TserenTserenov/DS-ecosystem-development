...
> Мы здесь учимся не «моему инструменту», а тому, что переносится на любой и еще тому, как развивать себя. 
...
**Далее будут несколько понятий, через которые дальше смотрим на всё.**
...
«Думать про себя/о себе» — как мне, человеку, стать лучше.

**«Думать как железный человек»** — как "нам с костюмом" действовать, к чему стремиться и расти единым целым.
...
Часть 3 покажет как создавать и развивать костюм.
...
|---|---|---|
| **Т0 · Старт** | Попробовать без регистрации: диагностика, марафон, поиск знаний | в боте |
| **Т1 · Аккаунт** | Память между ботом, вебом и клубом | почта |
| **Т2 · Изучение** | Все руководства, полный профиль | подписка |
| **Т3 · Персонализация** | ИИ знает тебя и отвечает под тебя | заполнить профиль |
...
- **Память** — помнит тебя (факты о пользователе в каждый запрос)
- **Персона** — знает, что ты предпочитаешь (загружается  при старте сессии)
- **База знаний** — твоя библиотека (контент для работы)
- **Роли через скиллы и скрипты** — специализации под задачи
- **MCP** — связь с внешним миром
- **Агенты** — действуют сами исходя из контекста
...
# «Матрица»: загрузил роль — и умеешь

<div>

Тринити «загружает» программу пилота — и взлетает.

ИИ-агент: подгружает описание роли (Навигатор, Стратег и тп) и сразу действует по ней.
...
Сейчас реальный экран. Берем разные сценарии.
...
<div class="after"><b>Что изменилось:</b> работа держит контекст, результат — конкретный артефакт, а не «поговорили или пообщался в чате».</div>

---

# Пир-сессия: Claude + Kimi (+ Hermes)

<div class="cards-2">
<div class="card">
<h3>Формальные роли — фиксированы</h3>
<p><b>Писатель</b> — создаёт артефакт, держит контекст, пишет в файл<br>
<b>Критик</b> — оспаривает. При разногласии — эскалирует к пилоту</p>
</div>
<div class="card accent">
...
# Демо 6 · Память об ошибках (косяки)
...
<p>Здоровье, финансы, семья, работа, развитие — у каждой области свой агент. Ещё один направляет вопросы между ними, но данные не хранит. И отдельный проверяющий — только смотрит, менять не может.</p>
</div>
</div>
