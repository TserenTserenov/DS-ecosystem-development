...
*(2 минуты — без объяснений, просто показываю экран)*

- **Интерфейсы** — бот в Telegram, браузер, VS Code
- **Платформа** — Aisystant: доставляет знания, память, контекст
- **Агенты** — Claude (Anthropic), Kimi, Hermes
- **Я сам** — оператор и строитель
- **Хранилище знаний** — мои файлы и базы на ноутбуке
- **IWE** — мастерская, где работаю с агентами и создаю артефакты

> Это и есть «костюм». Сегодня разберём, как он устроен изнутри.
