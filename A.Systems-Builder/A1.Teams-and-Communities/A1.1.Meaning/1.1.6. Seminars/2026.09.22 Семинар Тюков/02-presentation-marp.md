...
<!-- Блок 4 · Пример из проектов акселератора -->

<!-- _header: "Блок 4 · Системное мышление для века ИИ" -->

# Пример из вашей же среды

<div class="lead">Участник этого же акселератора уже сделал агента для постов: папка с источниками конкурентов и форумов на входе, черновики постов на выходе.</div>

1. **Объект операции** - папка-источники → одобренные посты
2. **Структура и роли** - роль «Сборщик источников» (агент), роль «Автор поста» (агент), роль «Утверждающий» (человек - точка проверки)
3. **Реализация** - решалась последней, неважно какая модель

<span class="ex">«Ты ничего не выкладываешь, складываешь посты в эту папку» - формулировка самого участника. Модель не публикует сама - решение и публикация остаются за человеком.</span>
...
<!-- Блок 4 · Антипример: без роли-проверяющего -->

<!-- _header: "Блок 4 · Системное мышление для века ИИ" -->

# Что бывает без роли-проверяющего

<div class="lead">Тот же акселератор, другой участник: агент ежемесячно готовил финансовый отчёт для директора - сам решал, что в него писать. Роли-проверяющего не было.</div>

<div class="highlight-box"><p>«Он жутко мне врал» - агент показывал цифры, которых не было, и ссылался на правила, не заданные в промпте.</p></div>

<span class="ex">Автомат без роли человека-проверяющего - это не суждение, это неконтролируемая ошибка на выходе.</span>
...
<!-- Блок 5 · Пример разбора (кейс участника акселератора) -->
...
# Пример: инструкции для новых сотрудников

1. **Вход** - надиктованная заведующей аудиозапись или текст с рабочей информацией
2. **Действие ИИ** - роль «Черновик документа»: собрать инструкцию, регламент или чек-лист из надиктованного. Роль «Проверяющий» - сама заведующая, сверяет и утверждает перед выдачей сотрудникам
3. **Проверка** - полнота черновика не ниже 90%, критические ошибки уходят при перепроверке человеком
4. **Результат** - комплект документов на руках у сотрудников; время на ввод нового человека упало с 9 до 5 часов в день
5. **Реализация** - расшифровка аудио + ИИ-чат, конкретный сервис решается последним

<div class="highlight-box"><p>Заметьте порядок: реализация - последней. Сначала вход, роли и проверка. И у результата есть число, а не только «получилось».</p></div>
