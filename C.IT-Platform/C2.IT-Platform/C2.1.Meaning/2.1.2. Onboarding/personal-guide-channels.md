...
## Smoke wave-1 — чеклист прогонов (заполняется 15–17 мая)

> Consent = 7 пилотов (15 мая). Wave-1 готова к smoke. 5 пилотов × 3 интерфейса = 15 прогонов.

| # | Пилот (ID/TG) | Бот Create | Бот Read | Бот Reflect | Браузер Create | Браузер Read | Браузer Reflect | VS Code Create | VS Code Read | VS Code Reflect | Баги |
|---|---------------|------------|----------|-------------|----------------|--------------|-----------------|----------------|--------------|-----------------|------|
| 1 | — | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | — |
| 2 | — | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | — |
| 3 | — | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | — |
...
**Legend:** ⬜ не начат / 🔄 в процессе / ✅ passed / ❌ failed (баг-репорт создан)

**Баг-репорты:**
- `DS-my-strategy/inbox/bugs/bug-2026-05-XX-pg-<канал>-<пилот>.md`
