...
Нет VS Code или хотите работать из браузера? → [Как использовать IWE в браузере (claude.ai)](iwe-browser-setup.md)

> Captures, поиск по Pack и запись в personal-guide работают в браузере. Коммиты и Day Open — только в VS Code.
