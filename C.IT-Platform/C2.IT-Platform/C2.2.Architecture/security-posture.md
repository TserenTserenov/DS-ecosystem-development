...
<!-- COVERAGE-SYNC:START (generated by security-coverage-sync.sh, 2026-07-12T02:16Z) -->
...
| aisystant/digital-twin-mcp | enabled | нет | нет | да | нет |
...
> Сгенерировано детерминированно (gh api, без LLM) 2026-07-12T02:16Z. Не редактировать вручную между маркерами.
<!-- COVERAGE-SYNC:END -->
