...
<!-- COVERAGE-SYNC:START (generated by security-coverage-sync.sh, 2026-07-21T02:15Z) -->

| Репо | Secret scanning | Scan workflow | SAST | Branch protection (default) | Dependabot |
|------|-----------------|---------------|------|-----------------------------|------------|
| aisystant/aist_bot | ? | нет | нет | нет | нет |
| aisystant/activity-hub | ? | да | да | нет | нет |
...
> Сгенерировано детерминированно (gh api, без LLM) 2026-07-21T02:15Z. Не редактировать вручную между маркерами.
<!-- COVERAGE-SYNC:END -->
