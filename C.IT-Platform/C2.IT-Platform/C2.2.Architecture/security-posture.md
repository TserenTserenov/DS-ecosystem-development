...
<!-- COVERAGE-SYNC:START (generated by security-coverage-sync.sh, 2026-07-13T02:15Z) -->

| Репо | Secret scanning | Scan workflow | SAST | Branch protection (default) | Dependabot |
|------|-----------------|---------------|------|-----------------------------|------------|
| aisystant/aist_bot | enabled | нет | да | нет | нет |
| aisystant/activity-hub | нет | нет | нет | нет | нет |
| aisystant/event-gateway | нет | нет | да | нет | нет |
| aisystant/gateway-mcp | нет | нет | нет | нет | нет |
...
> Сгенерировано детерминированно (gh api, без LLM) 2026-07-13T02:15Z. Не редактировать вручную между маркерами.
<!-- COVERAGE-SYNC:END -->
