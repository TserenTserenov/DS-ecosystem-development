...
<!-- COVERAGE-SYNC:START (generated by security-coverage-sync.sh, 2026-07-05T02:15Z) -->
...
| aisystant/event-gateway | нет | нет | нет | нет | нет |
| aisystant/gateway-mcp | нет | да | да | нет | нет |
| aisystant/payment-receiver | нет | нет | нет | нет | нет |
...
> Сгенерировано детерминированно (gh api, без LLM) 2026-07-05T02:15Z. Не редактировать вручную между маркерами.
<!-- COVERAGE-SYNC:END -->
