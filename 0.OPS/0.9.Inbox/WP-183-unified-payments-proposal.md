...
|---|-----|-----|-----|------|-----------|
| 1 | ~~**Схема `finance.payments` в Neon**~~ — 1 таблица (§4) | Церен | -- | ✅ 8 апр | Создана в Neon. Дима валидировал. [SQL](WP-183-001-create-finance-payments.sql) |
| 2 | ~~**Экспорт истории**~~ из Aisystant PG → Neon | Церен + Дима | 1 + доступ (Паша) | ✅ 8 апр | 35839 строк: 19684 payment + 16155 charge_off. 2020–2026 |
