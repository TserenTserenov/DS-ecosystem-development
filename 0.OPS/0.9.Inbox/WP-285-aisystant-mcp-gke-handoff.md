...
>
> **Контекст:** кто разрабатывает MVP, кто принимает и разворачивает на GKE, кто разворачивает на российской инфраструктуре — см. [WP-415-russia-world-split-concept.md §6 «Поток разработки и передачи между контурами»](WP-415-russia-world-split-concept.md).
>
> **Разделение треков:**
