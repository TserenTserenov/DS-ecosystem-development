...
moved_from: "0.OPS/0.9.Inbox/WP-73-platform-documents-index.md (2026-06-15, РП-73 Ф3)"
---
...
>
> **Дом:** канонический навигационный реестр на мета-уровне `0.OPS/` (рядом с `REPOSITORY-REGISTRY.md`). Кросс-ядерный (A/B/C), поэтому не в `C2.2.Architecture`. Перенесён из транзитного `0.9.Inbox` 15 июня (РП-73 Ф3).
>
