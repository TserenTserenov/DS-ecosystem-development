...
related: [WP-246, WP-446, WP-424, WP-266, WP-397]
---
...
Без изменений к прежнему плану, плюс: приём стажировок переходит с ручных инвойсов на автоматический график; консолидация учёток ЮКассы — только с проверкой, что привязки карт не потеряются при объединении.
...
2. **Менеджер ЮКассы:** включение автосписаний в боевом магазине; можно ли перенести привязки карт при объединении учёток; условия сплитования (на случай пересмотра Д7).
