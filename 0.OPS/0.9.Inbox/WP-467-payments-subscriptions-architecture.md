...
1. Stripe-аккаунт Corp: подтвердить владельца, каталог тарифов, вебхук на новый Stripe-модуль.
...
1. **От Димы (этапы 2-3):** shopId учёток ЮКассы; возможность второго вебхук-URL (Q1); готовность к окну cutover автосписаний.
2. **От Андрея (этап 1):** сроки готовности auth-слоя aisystant.com (мировой эмитент токенов, П5).
