---
type: index
name: "Индекс документов новой платформы Aisystant IWE"
status: active
created: 2026-05-19
updated: 2026-05-19
...
# Индекс документов новой платформы Aisystant IWE (post-MVP)

> **Назначение:** единая точка входа для всех документов, описывающих новую архитектуру, концепцию, позиционирование и план развития платформы Aisystant IWE после пивота продукта (2026).
>
...
| S8 | Операционная система | IWE OS, оркестрация | `A3.2.Architecture/3.2.3.8. Операционная система ИТ-платформы/` |
