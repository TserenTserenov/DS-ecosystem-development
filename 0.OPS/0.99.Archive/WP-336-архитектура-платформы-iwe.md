...
### 3. Data Layers: Трёхслойное разделение данных
...
### 5. Parliament Model: Триада Учёт / Доступ / Аудит
...
### 6. Service Architecture: Domain-Isolated Services
...
|----------|---------|--------|
| IDE для работы в курсе | Cloud IDE / Embed Claude Code в браузер  ArchGate (Claude Code — хост Anthropic, не Aisystant) / Custom через Agent SDK | — |
...
### 10. Открытые вопросы для ArchGate
