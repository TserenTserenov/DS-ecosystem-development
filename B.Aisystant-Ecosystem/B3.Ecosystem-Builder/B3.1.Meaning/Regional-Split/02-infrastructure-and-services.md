...
| **Клуб** (Discourse) | **Нет** | Единое сообщество = единый клуб. Peer review, менторство, команды Б5 | Один инстанс, мультиязычный. JWT от любого Ory. Нет PII — только ory_id + ник |
...
| **LMS** (Aisystant) | Нет | Контент общий, доступ по подписке | Один инстанс |
